...
using Store_Core_Web_Exam.ViewModels;
...
namespace Store_Core_Web_Exam.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            {
                User user = await db.FindUserByLoginAsync(model.Email, model.Password);
                if (user != null)
                {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    var us = new User { Email = model.Email, Password = model.Password };
